...
const AudiencePage = () => {
  ...
  }, [dispatch, pagination.page, selectedShopId]);
  ...
  return (
    <div className="space-y-6 py-2">
      ...
      <NoShopGate description="Connect your TikTok Shop to start managing audiences and related ads data.">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className={`px-2 py-0.5 rounded-full text-label-caps border ${TYPE_COLORS[aud.type] || ''}`}>
                          {aud.type}
                        </span>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-label-caps text-outline">
                        {aud.campaigns} campaign{aud.campaigns !== 1 ? 's' : ''}
                      </p>
                    </div>
                  </div>
          ...
          <div className="space-y-4">
            <div className="glass-panel rounded-xl p-5">
              ...
              {(demo.gender || []).length === 0 ? (
                <p className="text-body-sm text-on-surface-variant">No demographic data yet.</p>
              ) : (
            ...
            <div className="glass-panel rounded-xl p-5">
              ...
              {(demo.age || []).length === 0 ? (
                <p className="text-body-sm text-on-surface-variant">No age data yet.</p>
              ) : (
            ...
            <div className="glass-panel rounded-xl p-5">
              ...
              {(demo.topRegions || []).length === 0 ? (
                <p className="text-body-sm text-on-surface-variant">No region data yet.</p>
              ) : (
                <div className="space-y-3">
